...
Figure 1 – ECG Variability Across People. Top row: Normal beats (N), middle row: Premature ventricular contractions (V), bottom row: Atrial premature beats (A). All signals are recorded using modified limb lead II (MLII) from different recordings of the MIT-BIH dataset.
